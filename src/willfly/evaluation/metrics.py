...
def calculate_metrics(results: Iterable[EpisodeResult], *, bootstrap_replicates: int = 0, seed: int = 0, min_blocks: int = 4) -> MetricReport:
    ...
    return MetricReport(
        ...
        None,
        interval,
        "insufficient_blocks" if len(blocks) < min_blocks else "pass",
    )
